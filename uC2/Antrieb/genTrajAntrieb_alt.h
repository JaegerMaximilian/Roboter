...
#define SPEED_LIMIT_FACTOR_    3.0	// 1.8 // 1.2
// Faktor zwischen Winkelgeschwindigkeit und Winkel
#define K_WINKEL_              1.5 // 2.0 // 1.2
...
#define SCHLEPP_FEHLER_TRANS_     0.4
...
#define W_MIN           (M_PI*20.0)/180.0
#define W_MAX			 	(M_PI*250.0)/180.0		//(M_PI*135.0)/180.0

// max. Motion (Calc)
#define MAX_CALC_ANTRIEB     40

// max. Motion (Eingabe)
#define MAX_IN_ANTRIEB       40
