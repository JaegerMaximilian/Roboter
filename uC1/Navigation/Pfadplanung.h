...
#ifndef PFADPLANUNG_EXTERN
	#define PFADPLANUNG_EXTERN extern
#endif
/* ***************************** */
/*			PROTOTYPES			 */
/* ***************************** */
...
#define PATH_OBSTACLE_LIST_LENGTH	20
/* obstacle indentifier (0,1,2) ... robots, (255) ... static obstacles */
#define PATH_OTHER_ROBOT			0
...
/* size of obstacles: center.x/y +/- PATH_OBSTACLE_SIZE */
#define PATH_OBSTACLE_SIZE			3
...
// Struct für die Hindernisse
typedef struct
{
	uint8_t enableObstical;           // Gibt an ob das Hindernis hinzugefügt werden soll oder nicht
	int8_t x;
	int8_t y;
	int8_t X;
	int8_t Y;
...
#define PATH_STATIC_OBSTICAL_LIST_LENGHT (PATH_OBSTACLE_LIST_LENGTH-5)
PFADPLANUNG_EXTERN StaticObstical_t StaticObsticalList[PATH_STATIC_OBSTICAL_LIST_LENGHT];

#define PATH_SET_OBSTICAL(i,b,c,d,e) {StaticObsticalList[i].enableObstical = 0; StaticObsticalList[i].x = b;StaticObsticalList[i].y = c;StaticObsticalList[i].X = d;StaticObsticalList[i].Y = e;}
#define PATH_ENABLE_OBSTACLE(i) {StaticObsticalList[i].enableObstical = 1;}
#define PATH_DISABLE_OBSTACLE(i) {StaticObsticalList[i].enableObstical = 0;}
